...
import a01077579.data.util.CompareByJoinedDate;
...
public class CustomerReader {
	...
	public CustomerReader(String customerInfos) throws ApplicationException {
		...
		customerIterator = new CustomerIterator();
	}
	...
	/**
	 * Sort the customers by the join date, called by outer if necessary
	 */
	public void sortCustomersByJoinDate() {
	...
	public class CustomerIterator {
		...
		public Customer getNext() {
			return hasNext() ? customers.get(index++) : null;
		}
	}
